...
class Demand(google.protobuf.message.Message):
    ...
    @property
    def product(self) -> volur.pork.products.v1alpha2.product_pb2.Product:
    ...
    def __init__(
        self,
        *,
        product: volur.pork.products.v1alpha2.product_pb2.Product | None = ...,
        plant: builtins.str = ...,
        customer_id: builtins.str = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["demand_on", b"demand_on", "dispatch_at", b"dispatch_at", "price_per_unit", b"price_per_unit", "product", b"product", "quantity", b"quantity"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["characteristics", b"characteristics", "customer_id", b"customer_id", "demand_on", b"demand_on", "dispatch_at", b"dispatch_at", "plant", b"plant", "price_per_unit", b"price_per_unit", "product", b"product", "quantity", b"quantity"]) -> None: ...
...
class UploadDemandInformationRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["demand", b"demand"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["demand", b"demand"]) -> None: ...
