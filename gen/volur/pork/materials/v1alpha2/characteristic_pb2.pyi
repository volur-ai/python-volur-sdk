...
class Characteristic(google.protobuf.message.Message):
    """MaterialCharacteristic defines a characteristic of a material with a named type and an associated value."""
...
class CharacteristicValue(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["value_bool", b"value_bool", "value_float", b"value_float", "value_integer", b"value_integer", "value_string", b"value_string"]) -> None: ...
