...
class MaterialInformationServiceServicer(metaclass=abc.ABCMeta):
    ...
    def UploadMaterialInformation(
        self,
        request_iterator: _MaybeAsyncIterator[volur.pork.materials.v1alpha2.material_pb2.UploadMaterialInformationRequest],
        context: _ServicerContext,
    ) -> typing.Union[collections.abc.Iterator[volur.pork.materials.v1alpha2.material_pb2.UploadMaterialInformationResponse], collections.abc.AsyncIterator[volur.pork.materials.v1alpha2.material_pb2.UploadMaterialInformationResponse]]:
        """UploadMaterialInformation allows client to upload a stream of material
        inventory information to the server and receive a stream of responses
        containing the status of each upload. This supports batch processing and
        real-time feedback on the operation.
