...
def add_ProductInformationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UploadProductInformation': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=volur_dot_pork_dot_products_dot_v1alpha1_dot_product__pb2.UploadProductInformationRequest.FromString,
                    response_serializer=volur_dot_pork_dot_products_dot_v1alpha1_dot_product__pb2.UploadProductInformationResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'volur.pork.products.v1alpha1.ProductInformationService', rpc_method_handlers)
