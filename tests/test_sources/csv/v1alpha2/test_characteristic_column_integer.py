...
from volur.sdk.v1alpha2.sources.csv.base import CharacteristicColumnInteger
...
test_data = [
    ...
    (
        ...
        None,
        True,
        "can not fetch the integer characteristic column with name column_name_does_not_exist",  # noqa: E501
    ),
    (
        {
            "column_name": "",
    ...
    (
        ...
        None,
        True,
        "can not parse value non-valid-integer-value in column column_name as integer value",  # noqa: E501
    ),
]
